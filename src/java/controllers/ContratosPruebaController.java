...
@ManagedBean
@ViewScoped
public class ContratosPruebaController implements Serializable{
        ...
        if(sessionController.correoConf.getPageToPage()==true){
         ...
         model=new LazyDataModel<Contrato>(){
            ...
            public List<Contrato> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
             ...
             result=movilidadService.listaLazyContratoPrueba(first,pageSize,sortField,sortOrder,filters,sessionController.correoConf);
            
                //setRowCount(10);
                setRowCount(movilidadService.countContratoPrueba(filters));
